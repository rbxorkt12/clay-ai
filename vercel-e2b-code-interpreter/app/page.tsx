    ...
    onFinish: async ({ object: fragment, error }) => {
      if (!error && fragment) {
        ...
        try {
          ...
          if (result.error) {
            posthog.capture('sandbox_error', { error: result.error })
            setMessage({
              role: 'assistant',
              content: [
                {
            ...
            posthog.capture('sandbox_success', {
          ...
          const error = err as SandboxError
          console.error('Failed to execute code:', error)
          posthog.capture('sandbox_error', { error: error.message })
          setMessage({
            role: 'assistant',
            content: [
              {
